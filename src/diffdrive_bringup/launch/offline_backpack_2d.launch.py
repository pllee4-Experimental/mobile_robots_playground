...
def generate_launch_description():
    ...
    configuration_directory_arg = DeclareLaunchArgument("configuration_directory", default_value = PathJoinSubstitution([FindPackageShare("diffdrive_bringup"), "config"
        ]))
    configuration_basenames_arg = DeclareLaunchArgument('configuration_basenames', default_value = 'cartographer.lua')
    urdf_filenames_arg = DeclareLaunchArgument('urdf_filenames', default_value = FindPackageShare('diffdrive_description').find('diffdrive_description') + '/urdf/robot.urdf')
    ...
    set_remap = SetRemap('lidar', 'echoes')
